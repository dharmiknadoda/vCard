      ...
      <div class="main-content mx-auto w-100 overflow-hidden bg-green">
        ...
        <div class="appointment-section pt-60 px-30">
          ...
          <div class="appointment">
            ...
            <div class="">
              <label class="fs-18 mb-5 appoint-hour">Hours :</label>
              <div class="row mb-3">
              ...
              <div class="text-center">
                <a href="#" class="btn btn-primary w-100 text-black">
                    Make an Appointment
                </a>
            </div>
            </div>
              ...
              <form action="">
                <div class="row">
                  ...
                  <div class="col-12 text-center">
                    <a href="#" class="send-btn rounded btn btn-primary">
                        Send Message
                    </a>
                </div>
                </div>
        ...
        <div class="pb-30">
            <div class="text-center">
                <a href="#" class="add-contact-btn rounded-2 btn btn-primary text-black">
                    <i
                class="fas fa-download fa-address-book"></i> Add to Contact
                </a>
            </div>
        </div>
