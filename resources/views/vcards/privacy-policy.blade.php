...
@elseif($privacyPolicy->vcard->template_id == 25)
vcard-twentyfive main-content w-100 mx-auto @endif
            @endif
...
@elseif($termCondition->vcard->template_id == 23)
            vcard-twentythree main-content w-100 mx-auto @endif
    @endif
            ">
            <div
                class="
...
vcard-twentythree-btn text-dark
@elseif($termCondition->vcard->template_id == 24)
vcard-twentyfour-btn text-light @endif
                @endif
