        ...
        function cardCategory(category) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $(".card-occupation").text(response.data['name_field']);
                    let imageUrl = "{{ asset('assets/images') }}/" + response.data['default_image'];
                    document.getElementById("coverPreview").style.backgroundImage = "url('" + imageUrl + "')";
                }
            })
            $("#mySidebar").addClass('bg-loder')
            $(".lodar-in").removeClass('d-none')
            $.ajax({
                method: 'POST',
                url: '{{ route('get.sub.menu') }}',
                data: {
                    cardCategoryId: cardCategoryId,
                    cardId: cardId,
                },
                success: function (response) {
                    $("#mySidebar").html(response.html);
                    $("#mySidebar").removeClass('bg-loder')
                    $(".lodar-in").addClass('d-none')
                }
            });
        }
    </script>
    <div class="row" id="basic">
        ...
        <div class="col-lg-6 mb-7">
            {{ Form::label('name', __('messages.vcard.card_category') . ':', ['class' => 'form-label required']) }}
                <select name="card_category" class="form-control card-category" data-control="select2"
                    onchange="cardCategory($(this))" data-user-id='{{ $vcard->id ?? '' }}'>
                @foreach(getCardCategory() as $category)
                    <option value="{{ $category['id'] }}"
                            data-id="{{ $category['template_id'] }}" {{ isset($vcard) && $vcard->card_category == $category['id'] ? 'selected' : '' }}>
                        {{ $category['name'] }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="col-lg-6 mb-7">
            {{ Form::label('occupation', __('messages.vcard.occupation') . ':', ['class' => 'form-label , card-occupation']) }}
            ...
            @foreach ($templates as $id => $url)
                @if(in_array($id,$templateIds))
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 mb-3 templatecard">
                        <div
                            class="img-radio img-thumbnail card-category-hide {{ $id == 11 ? 'screen vcard_11' : '' }} {{ $vcard->template_id == $id ? 'img-border' : '' }} @if ($id == 22) ribbon @endif"
                            data-id="{{ $id }}">
        ...
        @if ($partName == 'appointments')
            <div class="col-12">
                                        ...
                                        <div class="weekly-icon position-absolute end-0 d-flex">
                                            <a href="javascript:void(0)" class="add-session-time"
                                               ...
                                               data-bs-toggle="tooltip" title="{{ __('messages.common.add') }}">
                                                <i class="fa fa-plus text-primary me-5 fs-2 mb-3"
                                                   aria-hidden="true"></i>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="card-body px-0 pt-0">
                    <div
                        class="row {{ isset($appointmentDetail->is_paid) && $appointmentDetail->is_paid == 1 ? '' : 'd-none' }}"
                        id="userPaidInputDiv">
                        <div class="col-12">
                            <div class="row">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col order-last form-check form-switch mt-8">
                                        <input class="form-check-input" name="applySetting" type="checkbox"
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-6">
                                                    ...
                                                    <label class="form-label mb-0 me-2" for="">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.vcard.header') !!}</span>
                                                    </label>
                                                </div>
                                                <div class="col-6">
                                                    <input id="contactListCheckbox" class="form-check-input"
                                                    ...
                                                    <label class="form-label mb-0 me-2" for="contactListCheckbox">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.vcard.contact') !!}</span>
                                                    </label>
                                                </div>
                                                @if (checkFeature('services'))
                                                    <div class="col-6 mt-5">
                                                        <input id="servicesCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="services"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="servicesCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.services') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if (checkFeature('gallery'))
                                                    <div class="col-6 mt-5">
                                                        <input id="galleriesCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="galleries"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="galleriesCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.galleries') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if (checkFeature('products'))
                                                    <div class="col-6 mt-5">
                                                        <input id="productsCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="products"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="productsCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.products') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if (checkFeature('testimonials'))
                                                    <div class="col-6 mt-5">
                                                        <input id="testimonialsCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="testimonials"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="testimonialsCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.testimonials') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if (checkFeature('blog'))
                                                    <div class="col-6 mt-5">
                                                        <input id="blogsCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="blogs"
                                                            {{ (isset($managesection) && $managesection['blogs']) || empty($managesection) ? 'checked' : '' }}>
                                                        <label class="form-label mb-0 me-2" for="blogsCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.blogs') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                <div class="col-6 mt-5">
                                                    <input id="businessHoursCheckbox" class="form-check-input"
                                                           type="checkbox" value="1"
                                                           name="business_hours"
                                                    ...
                                                    <label class="form-label mb-0 me-2" for="businessHoursCheckbox">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.vcard.business_hours') !!}</span>
                                                    </label>
                                                </div>
                                                @if (checkFeature('appointments'))
                                                    <div class="col-6 mt-5">
                                                        <input id="appointmentsCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="appointments"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="appointmentsCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.appointments') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                <div class="col-6 mt-5">
                                                    <input id="mapCheckbox" class="form-check-input" type="checkbox"
                                                           value="1" name="map"
                                                        {{ (isset($managesection) && $managesection['map']) || empty($managesection) ? 'checked' : '' }}>
                                                    <label class="form-label mb-0 me-2" for="mapCheckbox">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.vcard.map') !!}</span>
                                                    </label>
                                                </div>
                                                <div class="col-6 mt-5">
                                                    <input id="bannerCheckbox" class="form-check-input" type="checkbox"
                                                           value="1" name="banner"
                                                        {{ (isset($managesection) && $managesection['banner']) || empty($managesection) ? 'checked' : '' }}>
                                                    <label class="form-label mb-0 me-2" for="bannerCheckbox">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.front_cms.banner_title') !!}</span>
                                                    </label>
                                                </div>
                                                @if (checkFeature('insta_embed'))
                                                    <div class="col-6 mt-5">
                                                        <input id="instaembedCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="insta_embed"
                                                        ...
                                                        <label class="form-label mb-0 me-2" for="instaembedCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.feature.insta_embed') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                @if (checkFeature('iframes'))
                                                    <div class="col-6 mt-5">
                                                        <input id="iframeCheckbox" class="form-check-input"
                                                               type="checkbox" value="1"
                                                               name="iframe"
                                                            {{ (isset($managesection) && $managesection['iframe']) || empty($managesection) ? 'checked' : '' }}>
                                                        <label class="form-label mb-0 me-2" for="iframeCheckbox">
                                                            <span
                                                                class="ms-4 d-md-block">{!! __('messages.vcard.iframe') !!}</span>
                                                        </label>
                                                    </div>
                                                @endif
                                                <div class="col-6 mt-5">
                                                    <input id="newsLatterPopupCheckbox" class="form-check-input"
                                                           type="checkbox" value="1"
                                                    ...
                                                    <label class="form-label mb-0 me-2" for="newsLatterPopupCheckbox">
                                                        <span
                                                            class="ms-4 d-md-block">{!! __('messages.vcard.newslatter_popup') !!}</span>
                                                    </label>
                                                </div>
                                            </div>
                                            {{-- <div class="col-6 mt-5">
                                                        ...
                                                        <div class="col text-md-start text-center">
                                                            ...
                                                            <div class="col">
                                                                <label class="button-label mx-2 mb-3">
                                                                    <input type="radio" name="sticky_bar"
                                                                           class="sticky-btn"
                                                                           value="0"{{ isset($dynamicVcard['sticky_bar']) && $dynamicVcard['sticky_bar'] == 0 ? 'checked' : '' }}>
                                                                    <span
                                                                        class="sticky-btn-title">{{ __('messages.vcard.left') }}</span>
                                                                </label>
                                                                <label class="button-label mx-2">
                                                                    ...
                                                                    <span
                                                                        class="sticky-btn-title">{{ __('messages.vcard.right') }}</span>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
