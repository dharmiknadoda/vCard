@component('mail::layout')
    ...
    <div>
        ...
        <p>To enhance the security of your account, we have implemented a two-factor authentication (2FA) process. Please use the verification code below to complete your login:</p>
