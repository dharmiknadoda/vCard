...
@section('content')
    <?php
        ...
        $cardViewCount = (isset($viewCount)) ? $viewCount : 0;
    ?>
@role('super_admin')
                    ...
                    <div class="d-flex">
                        ...
                        <div class="card-toolbar ms-auto">
                            <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="dayData" role="tablist">
                                ...
                                <li class="nav-item position-relative me-7 mb-3" role="presentation">
                                    <button class="nav-link p-0" id="weekData" data-bs-toggle="tab" data-bs-target="#vcards"
        ...
        <div class="row">
            ...
            <div class="col-12 mb-4">
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="{{ route('vcards.edit', $updateCardId) }}" class="text-decoration-none cursor-pointer bg-success shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                            <div class="bg-green-300 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                 <i class="fa-solid fa-edit fs-1-xl text-white"></i>
{{--                                <img src="{{ asset('assets/img/dashboard/deactive-vcard.svg') }}" alt="" class="w-50 h-50">--}}
                            </div>
                            <div class="text-end text-white">
                                <h3 class="mb-0 fs-4 fw-light">{{ __('messages.common.edit_card') }}</h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="{{ route('inquiries.index') }}" class="text-decoration-none bg-info shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="{{ route('appointments.index') }}" class="text-decoration-none bg-warning shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="{{ route('vcard.analytics', $updateCardId)}}" class="text-decoration-none bg-danger shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                            <div class="bg-red-300 widget-icon rounded-10 d-flex align-items-center justify-content-center">
{{--                                <i class="fa-solid fa-calendar-check fs-1-xl text-white"></i>--}}
                                <i class="fa-solid fa-chart-line fs-2 text-white"></i>
                            </div>
                            <div class="text-end text-white">
                                <h3 class="mb-0 fs-4 fw-light">{{ __('messages.common.view_stats') }}</h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <div class="bg-warning shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center
                            justify-content-between my-3">
                            <div class="bg-yellow-300 widget-icon rounded-10 d-flex align-items-center justify-content-center">
                                <i class="fa-solid fa-eye fs-1-xl text-white"></i>
                            </div>
                            <div class="text-end text-white">
                                <h2 class="fs-1-xxl fw-bolder text-white">{{ $cardViewCount }}</h2>
                                <h3 class="mb-0 fs-4 fw-light">{{ __('messages.common.total__view_vcards') }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
