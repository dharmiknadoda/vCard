            ...
            <div class="vcard-one__product py-3 mt-0">
                <div class="row justify-content-between">
                    ...
                    <div class="col-4 mt-8 text-center">
                        <a class="back-btn text-decoration-none" href="{{ route('vcard.show', ['alias' => $vcard->url_alias]) }}"
                                ...
                                <div class="product-img card-img">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        target="_blank" class="text-decoration-none fs-6"><img
                                            ...
                                            class="w-50 mt-3 object-fit-cover rounded-2 " height="208px" loading="lazy"></a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="my-5 text-center">
                                        <button class="buy-product text-decoration-none" data-id="{{ $product->id }}">{{ __('messages.subscription.buy_now') }}</button>
                                    </div>
                                @endif
                                </div>
                            </div>
