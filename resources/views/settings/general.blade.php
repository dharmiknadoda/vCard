                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mb-3">
                                        {{ Form::label('userVerfiedEnable', __('messages.common.user_varified') . ':', ['class' => 'form-label mb-3']) }}
                                        <label class="form-check form-switch form-switch-sm cursor-pointer">
                                            ...
                                            <span class="form-check-label text-gray-600"
                                                for="userVerfiedEnable">{{ __('messages.common.user_varified') }}</span>&nbsp;&nbsp;
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <label class="form-check form-switch form-switch-sm cursor-pointer">
                                            <input type="checkbox" name="url_alias" class="form-check-input"
                                                value="1" {{ $setting['url_alias'] == '1' ? 'checked' : '' }}
                                                id="">
                                            <span class="form-check-label text-gray-600"
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4 mb-3">
                                    <div class="mb-3" io-image-input="true">
                                        ...
                                        <span data-bs-toggle="tooltip" data-placement="top"
                                            data-bs-original-title="{{ __('messages.tooltip.signin_logo') }}">
                                            <i class="fas fa-question-circle ml-1 mt-1 general-question-mark"></i>
                                        </span>
                                        <div class="d-block">
                                            <div class="image-picker">
                                                ...
                                                <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                    data-bs-toggle="tooltip" data-placement="top"
                                                    data-bs-original-title="{{ __('messages.tooltip.change_signin_logo') }}">
                                                    <label>
                                                        <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                            ...
                            <a href="{{ route('generateSitemap') }}"
                            class="btn btn-primary mb-5"><i class="fa-solid fa-sitemap"></i> {{ __('messages.gnerate_sitemap') }}</a>
                        </div>
                    </div>
                </div>
                <div>
