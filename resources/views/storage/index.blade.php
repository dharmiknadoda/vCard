        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body" style="height:550px">
                    ...
                    <div>
                        <canvas id="storagePieChart" style="height: 300px"></canvas>
                    </div>
                    <div class="mt-7">
                        <!-- Legend -->
                        ...
                        <div class="mt-5 text-end">
                            {{ intval(totalStorage()) }} MB / {{ $storageLimit }} MB
                        </div>
                        <div class="progress mt-5">
                            <div class="progress-bar" role="progressbar" style="width: {{ (totalStorage() / $storageLimit) * 100 }}%;" aria-valuenow="{{ totalStorage() }}" aria-valuemin="0" aria-valuemax="{{ $storageLimit }}"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="overflow-auto">
                        ...
                        <table class="table w-100 table-borderless" style="white-space: nowrap">
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($productStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($serviceStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($testimonialStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($socialStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($blogStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($galleryStorageMB, 2) }} MB</td>
                            ...
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($profileStorageMB, 2) }} MB</td>
                    ...
                    <div class="overflow-auto">
                        <table class="table w-100 table-borderless" style="white-space: nowrap">
                            <tr>
                                ...
                                <td class="pe-0" style="width:120px;">{{ number_format($pwaStorageMB, 2) }} MB</td>
                                <td class="pe-0" style="width:120px;">{{ number_format(($pwaStorageMB / $storageLimit) * 100, 2) }}%</td>
                            </tr>
                            <tr>
                                <td class="ps-0">{{ __('messages.user.avatar') }}</td>
                                <td class="pe-0" style="width:120px;">{{ number_format($avatarStorageMB, 2) }} MB</td>
