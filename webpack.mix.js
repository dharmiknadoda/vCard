...
mix.copyDirectory('resources/assets/scss/new_home/bootstrap.min.css', 'public/assets/css/new_home')
mix.copyDirectory('resources/assets/img/dashboard', 'public/assets/img/dashboard')
...
mix.sass('resources/assets/scss/new_home/index.scss', 'public/assets/css/new_home/index.css').
    sass('resources/assets/scss/new_home/custom.scss', 'public/assets/css/new_home/custom.css').
    sass('resources/assets/scss/faqs/faqs.scss', 'public/assets/css/faqs/faqs.css').
    sass('resources/assets/scss/new_home/slick.scss', 'public/assets/css/new_home/slick.css').
    sass('resources/assets/scss/new_home/slick-theme.scss', 'public/assets/css/new_home/slick-theme.css').
    sass('resources/assets/scss/new_home/layout.scss',
        'public/assets/css/new_home/layout.css').version()
